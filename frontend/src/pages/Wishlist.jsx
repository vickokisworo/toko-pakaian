      ...
      <div className="product-content">
        {loading && WishlistProducts.length === 0 ? (
          ...
          <div className="card" style={{ textAlign: "center", padding: "4rem 2rem" }}>
            <h3 style={{ color: "var(--text-muted)" }}>No Wishlist Product</h3>
            <p>You haven't added any product to your Wishlists yet.</p>
            <a 
              href="#/product" 
                  ...
                  <div className="product-info">
                      <div onClick={() => setSelectedProduct(p)} style={{ cursor: "pointer" }}>
                          <div style={{ display: "flex", alignItems: "flex-start", gap: "0.35rem", height: "3rem" }}>
                              ...
                              {isPelanggan && (
                                  <button
                                      className="btn-Wishlist btn-Wishlist--inline active"
              ...
              <div className="modal-overlay" onClick={() => setSelectedProduct(null)}>
                  <div className="modal-content" style={{ maxWidth: "650px" }} onClick={e => e.stopPropagation()}>
                      ...
                      <div className="modal-footer">
                          ...
                          {isPelanggan && (
                              <button
                                  className="btn-Wishlist-modal active"
                                  onClick={(e) => { e.stopPropagation(); handleRemoveWishlist(selectedProduct.id); setSelectedProduct(null); }}
                                  disabled={loading}
